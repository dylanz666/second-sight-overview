...
async function fetchAndDisplayServices() {
    ...
    try {
        ...
        deviceIds.forEach(deviceId => {
            ...
            // left 60 seconds for network delay
            const isOnline = lastTimestamp > -1 && currentTimestamp - lastTimestamp <= 180;
        ...
        servicesContainer.querySelectorAll('.test-connection-btn').forEach(btn => {
            ...
            newBtn.addEventListener('click', async function () {
                ...
                try {
                    ...
                    ok = currentTimestamp2 - lastTimestamp2 <= 180 && currentTimestamp2 > -1 && lastTimestamp2 > -1;
                    result = ok
